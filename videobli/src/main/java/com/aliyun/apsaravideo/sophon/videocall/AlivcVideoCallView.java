...
public class AlivcVideoCallView extends FrameLayout implements RTCBeaconTowerCallback {
    ...
    private void startPreview() {
        ...
        RTCBeaconTowerImpl.sharedInstance().stopPreview();
    }
...
//            if (aliRtcNetworkQuality == Network_Excellent) {  //网络极好
...
//                }
//            } else if (aliRtcNetworkQuality == Network_Good) {  //网络好
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
...
//                }
//            } else if (aliRtcNetworkQuality == Network_Poor) {  //网络较差
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
...
//                }
//            } else if (aliRtcNetworkQuality == Network_Bad) {  //网络差，视频卡顿
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
...
//                }
//            } else if (aliRtcNetworkQuality == Network_VeryBad) {  //网络极差，基本无法沟通
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (aliRtcNetworkQuality == Network_Disconnected) {  //网络中断
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (aliRtcNetworkQuality == Network_Unknow) {  //未知原因
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            }
