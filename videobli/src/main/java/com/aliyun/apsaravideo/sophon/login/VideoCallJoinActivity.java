...
public class VideoCallJoinActivity extends BaseActivity implements View.OnClickListener, TextChangeListener {
    ...
    public void onEventIMMessageMainThread(IMMessageEvent event) {
        String message = "";
        switch (event.getFlag()) {
            case JGApplication.SEND_IM_MESSAGE:
                message = event.getInfo();
...
public void  shopDialog(final  MessageBean bean){
