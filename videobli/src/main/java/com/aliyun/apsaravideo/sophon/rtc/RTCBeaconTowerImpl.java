...
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Bad;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Disconnected;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Excellent;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Good;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Poor;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_Unknow;
import static com.alivc.rtc.AliRtcEngine.AliRtcNetworkQuality.Network_VeryBad;
...
public class RTCBeaconTowerImpl extends BaseRTCBeaconTower{
    ...
    public void init() {
        if (mAliRtcEngine == null) {
            ...
            mAliRtcEngine.setPreCameraType(0);
            //手动发布，手动订阅
            mAliRtcEngine.setAutoPublishSubscribe(false, false);
            mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_720_960P_15,AliRtcVideoTrackCamera);
        }
    }
    ...
    class VideoAliRtcEngineEventListener extends AliRtcEngineEventListener {
        ...
        public void onNetworkQualityProbeTest(AliRtcEngine.AliRtcNetworkQuality quality) {
            super.onNetworkQualityProbeTest(quality);
//            if (quality == Network_Excellent) {  //网络极好
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_720_1280P_30, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_Good) {  //网络好
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_720_960P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_Poor) {  //网络较差
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_480_640P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_Bad) {  //网络差，视频卡顿
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_VeryBad) {  //网络极差，基本无法沟通
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_Disconnected) {  //网络中断
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            } else if (quality == Network_Unknow) {  //未知原因
//                if (RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine != null) {
//                    RTCBeaconTowerImpl.sharedInstance().mAliRtcEngine.setVideoProfile(AliRtcEngine.AliRtcVideoProfile.AliRTCSDK_Video_Profile_180_240P_15, AliRtcVideoTrackCamera);
//                }
//            }
