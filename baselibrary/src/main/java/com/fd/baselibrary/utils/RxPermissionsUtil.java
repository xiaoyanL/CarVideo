...
public class RxPermissionsUtil {
    ...
    public static final String[] CAMERA_STORAGE = new String[]
            {permission.CAMERA,permission.RECORD_AUDIO, permission.WRITE_EXTERNAL_STORAGE, permission.READ_EXTERNAL_STORAGE,permission.ACCESS_COARSE_LOCATION,permission.ACCESS_FINE_LOCATION};
