...
//    public static final String DEFAULT_CHANNEL = "test.bmw.pay.broadcast";
    ...
    public static final String HANG_UP = "Hangup"; //挂断
    public static final String HANG_ANSWER = "Answer"; //接听
    public static final String HANG_CALL = "Call"; //接听
    public static final String HANG_WEB = "web"; //web离线
    public static final String HANG_SIGN = "sign"; //注销

    public static final String MAIN_LOING_ACTIVITY = "/module_main/loingactivity";//登录
}
